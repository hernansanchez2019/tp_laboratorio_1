/** \brief Funcion para sumar numeros enteros
 *
...
/** \brief Funcion para restar numeros enteros
 *
 * \param num1 int Le pedimos al usuario el primer numero a calcular
 * \param num2 int Le pedimos al usuario el segundo numero a calcular
...
/** \brief Funcion para multiplicar enteros
 *
 * \param num1 int Le pedimos al usuario el primer numero a calcular
 * \param num2 int Le pedimos al usuario el segundo numero a calcular
...
/** \brief Funcion para dividir enteros y devolver flotantes
 *
 * \param num1 int Le pedimos al usuario el primer numero a calcular
 * \param num2 int Le pedimos al usuario el segundo numero a calcular
